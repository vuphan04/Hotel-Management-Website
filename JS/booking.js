...
function setAmt() {
    ...
    if (pckgType == 1) {
        tax.value = ((75 * parseInt(numofRooms.value)) * 12 / 100) + " (Dollar)";
        totalamt.value = (75 * parseInt(numofRooms.value)) + parseInt(tax.value) + " (Dollar)";;
    }
    else if (pckgType == 2) {
        tax.value = ((100 * parseInt(numofRooms.value)) * 12 / 100) + " (Dollar)";
        totalamt.value = (100 * parseInt(numofRooms.value)) + parseInt(tax.value) + " (Dollar)";;
    }
    else if (pckgType == 3) {
        tax.value = (150 * parseInt(numofRooms.value)) * 12 / 100 + " (Dollar)";
        totalamt.value = (150 * parseInt(numofRooms.value)) + parseInt(tax.value) + "(Dollar)";;
    }
    else if (pckgType == 4) {
        tax.value = (200 * parseInt(numofRooms.value)) * 12 / 100 + " (Dollar)";
        totalamt.value = (200 * parseInt(numofRooms.value)) + parseInt(tax.value) + " (Dollar)";
    }
